...
```{r}
# BB data has been open sourced, so I pre-loaded the BB data in the LAGOtrials package
bb_data <- LAGOtrials::BB_data
head(bb_data)
```

## Calculate the recommended interventions using the LAGOtrials package 
```{r}
