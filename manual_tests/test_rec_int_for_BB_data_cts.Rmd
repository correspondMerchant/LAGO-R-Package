...
```{r}
# using the cubic cost function with grid search
optimization_cubic_results <- calculate_recommended_interventions(
                                    ...
                                    intervention_lower_bounds = c(1,1),
                                    intervention_upper_bounds = c(40, 5),
                                    cost_list_of_lists = list(c(0, 380, -24, 0.6), c(0, 1700, -950, 220)),
                                    outcome_goal = 0.8)
optimization_cubic_results
# 35.50, 3.97, same as in the continuous outcome paper 
```

```{r}
# using the cubic cost function with numerical algorithm
optimization_cubic_results <- calculate_recommended_interventions(
                                    df = BB_proportions,
                                    outcome_name = "EBP_proportions",
                                    outcome_type = "continuous", 
